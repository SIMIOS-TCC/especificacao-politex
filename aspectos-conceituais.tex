...
Além disso, foi requerido desenvolver um algoritmo para obtenção do mapeamento da posição dos macacos. Este tema já havia sido discutido por Amaral e Biscaro \cite{larissaamaralmiltonbiscaro} e, para tanto, o algoritmo computacional desenvolvido se baseou na trilateração e em \emph{cellbased}.
